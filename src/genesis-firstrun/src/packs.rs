...
mod tests {
    ...
    fn draft_model_enables_speculative_decoding_on_gpu() {
        ...
        assert!(cpu.contains("big: \"llama-server --port ${PORT} --host 127.0.0.1 -ngl 0 -dev none -t 4"));
