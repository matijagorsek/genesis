...
pub fn tool_schemas() -> Value {
    json!([
        ...
        {"type":"function","function":{"name":"write_file","description":"Create or overwrite a text file with the given content.","parameters":{"type":"object","properties":{"path":{"type":"string","description":"the file's path, for example /home/you/Projects/app/index.html"},"content":{"type":"string","description":"the whole file, exactly as it should be on disk: plain text, not wrapped in quotes, not escaped"}},"required":["path","content"]}}},
