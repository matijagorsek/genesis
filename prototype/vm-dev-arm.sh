...
exec qemu-system-aarch64 -M virt,highmem=on -accel hvf -cpu host -smp "${GENESIS_VM_CPUS:-6}" -m "${GENESIS_VM_MEM:-8192}" \
  ...
  -netdev user,id=n0,hostfwd=tcp::2223-:22,hostfwd=tcp::11513-:11510,hostfwd=tcp::11523-:11520,hostfwd=udp::1716-:1716,hostfwd=tcp::1716-:1716,hostfwd=tcp::11530-:11530 -device virtio-net-pci,netdev=n0
